...
public class SolverProcessor {
    ...
    private Set<Integer> checkAll(int rowIndex, int elementIndex) {
        ...
        Set<Integer> rowValues = checkRow(rowIndex, elementIndex);
        Set<Integer> columnValues = checkColumn(rowIndex, elementIndex);
    ...
    private Set<Integer> checkRow(int rowIndex, int elementIndex) {
    ...
    private Set<Integer> checkColumn(int rowIndex, int elementIndex) {
    ...
    private void checkPossibleValues(int rowIndex, int elementIndex, Set<Integer> possibleValue) {
        ...
        for (Integer integer : possibleValue) {
            ...
            boolean amongRowPossibleValues = isAmongRowPossibleValues(rowIndex, elementIndex, integer);
            boolean amongColumPossibleValues = isAmongColumPossibleValues(rowIndex, elementIndex, integer);
    ...
    private boolean isAmongRowPossibleValues(int rowIndex, int elementIndex, int possibleValue) {
    ...
    private boolean isAmongColumPossibleValues(int rowIndex, int elementIndex, int possibleValue) {
